...
function InformationPanel() {
    ...
    const takeIcon = <GiTakeMyMoney className="edit icon box-1" />;
    const payIcon = <GiPayMoney className="icon box-2" />;
    const receiveIcon = <GiReceiveMoney className="icon box-3" />;
